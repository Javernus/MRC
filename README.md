...
```
cd existing_repo
git remote add origin https://gitlab-fnwi.uva.nl/mm22/project12/mrc.git
git branch -M main
...
- [ ] [Set up project integrations](https://gitlab-fnwi.uva.nl/mm22/project12/mrc/-/settings/integrations)
