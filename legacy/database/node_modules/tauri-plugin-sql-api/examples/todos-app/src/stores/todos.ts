...
import Storage from 'tauri-plugin-sql-api/examples/todos-app/src/services/Storage';
import type { Todo, NewTodo, ExistingTodo } from 'tauri-plugin-sql-api/examples/todos-app/src/models/Todo';
