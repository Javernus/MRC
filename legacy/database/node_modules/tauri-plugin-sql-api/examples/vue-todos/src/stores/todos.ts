...
import Storage from 'tauri-plugin-sql-api/examples/vue-todos/src/services/Storage';
import type { Todo, uuid } from 'tauri-plugin-sql-api/examples/vue-todos/src/models/Todo';
